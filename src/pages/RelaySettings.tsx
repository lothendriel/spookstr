    ...
    <div className="container max-w-4xl mx-auto space-y-6 py-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Manage your Nostr relay connections and advanced discovery features.
        </p>
      </div>
        ...
        <TabsContent value="discovery" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Spookstr automatically discovers relay hints from events to improve content discovery across the Nostr network.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <Alert className="border-lime-500/30 bg-lime-500/5">
                ...
                <AlertDescription>
                  <div className="space-y-2">
                    <p className="font-semibold">🚀 Relay Hint System Active</p>
                    <p className="text-sm">
                      When you view quoted posts, reply threads, or user profiles, Spookstr automatically extracts relay hints
                      from event tags and queries those relays for better content discovery. This mimics how advanced clients
                      like Amethyst and Damus work.
                    </p>
                  </div>
                </AlertDescription>
              </Alert>
                  ...
                  <CardContent className="p-4">
                    <div className="space-y-2">
                      ...
                      <ul className="text-xs text-muted-foreground space-y-1">
                        <li>• Extracts relay URLs from 'e', 'p', 'a', and 'r' tags in events</li>
                        <li>• Caches discovered relay hints for faster subsequent queries</li>
                        <li>• Automatically queries relay hints when fetching quoted posts</li>
                        <li>• Uses outbox model (NIP-65) for user content discovery</li>
                        <li>• Respects relay limits to prevent overloading</li>
                      </ul>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-dashed">
                  <CardContent className="p-4">
                    <div className="space-y-2">
                      ...
                      <ul className="text-xs text-muted-foreground space-y-1">
                        <li>• Much higher success rate for finding quoted content</li>
                        <li>• Better thread completion and reply discovery</li>
                        <li>• Automatic discovery of user content across relays</li>
                        <li>• Follows the same patterns as premium Nostr clients</li>
                        <li>• Works transparently without user configuration</li>
                      </ul>
                    </div>
                  </CardContent>
                </Card>
              ...
              <div className="pt-4 border-t">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-semibold text-sm">Relay Hint Cache</h4>
                    <p className="text-xs text-muted-foreground">
                      Temporarily stores discovered relay hints to improve performance
                    </p>
                  </div>
                  <Button
                    variant="outline"
                    ...
                    onClick={() => {
                      ...
                      toast({
                        title: "Cache cleared",
                        description: "Relay hint cache has been cleared. New hints will be discovered as you browse.",
                      });
                    }}
                  >
                    Clear Cache
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                📥 Inbox/Outbox Model (NIP-65)
              </CardTitle>
              <CardDescription>
                Modern relay usage pattern for optimal content discovery and delivery
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <h4 className="font-semibold text-sm mb-2">Write Relays (Outbox)</h4>
                  <p className="text-xs text-muted-foreground mb-2">
                    Where you publish your content. Others query these to find your posts.
                  </p>
                  <ul className="text-xs text-muted-foreground space-y-1">
                    <li>• Profile pages query your write relays</li>
                    <li>• Your followers discover your content here</li>
                    <li>• Should be reliable, fast relays</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-semibold text-sm mb-2">Read Relays (Inbox)</h4>
                  <p className="text-xs text-muted-foreground mb-2">
                    Where you check for mentions and notifications. Others send replies here.
                  </p>
                  <ul className="text-xs text-muted-foreground space-y-1">
                    <li>• Others send mentions and replies here</li>
                    <li>• You check these for notifications</li>
                    <li>• Can overlap with write relays</li>
                  </ul>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Relay Performance & Usage
              </CardTitle>
              <CardDescription>
                Monitor your relay connections and discovery statistics
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Alert className="border-blue-500/30 bg-blue-500/5">
                ...
                <AlertDescription>
                  <div className="space-y-2">
                    <p className="font-semibold">📊 Enhanced Monitoring</p>
                    <p className="text-sm">
                      Your Spookstr client is now equipped with advanced relay discovery capabilities similar to
                      premium Nostr clients. The system automatically finds the best relays for each type of content
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <Card className="border-dashed">
                    <CardContent className="p-4 text-center">
                      <div className="text-2xl font-bold text-lime-400">{localRelays.length + 1}</div>
                      <div className="text-xs text-muted-foreground">Total Relays</div>
                      <div className="text-xs text-muted-foreground mt-1">
                        {localRelays.filter(r => r.mode === 'both').length + 1} read+write
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-dashed">
                    <CardContent className="p-4 text-center">
                      <div className="text-2xl font-bold text-blue-400">{localSearchRelays.length}</div>
                      <div className="text-xs text-muted-foreground">Search Relays</div>
                      <div className="text-xs text-muted-foreground mt-1">
                        For hashtags & discovery
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-dashed">
                    <CardContent className="p-4 text-center">
                      <div className="text-2xl font-bold text-purple-400">{localBlossomServers.length}</div>
                      <div className="text-xs text-muted-foreground">Blossom Servers</div>
                      <div className="text-xs text-muted-foreground mt-1">
                        For file uploads
                      </div>
                    </CardContent>
