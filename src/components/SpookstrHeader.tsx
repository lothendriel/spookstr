      ...
      <div className="max-w-6xl mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button className="bg-lime-500 hover:bg-lime-400 text-black font-semibold" onClick={() => navigate('/ghost-hunt-maps')}>
              <MapPin className="h-4 w-4 mr-0" />
              <span className="hidden sm:inline ml-2">Ghost Maps</span>
            </Button>
