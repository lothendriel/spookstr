  ...
  const renderMedia = () => {
    switch (media.type) {
      ...
      case 'instagram':
        ...
        // Instagram embed using official embed API
        return (
          <div className="relative rounded-lg overflow-hidden bg-white group">
            ...
            <div className="relative" style={{ paddingBottom: instagramType === 'reel' ? '177.77%' : '120%' }}>
              <iframe
                ...
                src={`https://www.instagram.com/${instagramType === 'reel' ? 'reel' : 'p'}/${instagramId}/embed`}
                title={`Instagram ${instagramType}`}
                frameBorder="0"
                scrolling="no"
                ...
                onError={(e) => {
                  ...
                  console.log('📷 Instagram type:', instagramType);
                }}
              />
            </div>
